# app.py — AI Budget Assistant (Primary: Dept + Account Description + Account Type)
...
with cols[1]:
    ...
    q = st.text_input(
        ...
        placeholder="e.g., 'Actual spent in 2021-06 for HR', 'Budget for Account Type Supplies 2021-11', 'Variance for Account Desc Office Supplies in FY2021'"
    )
    if q:
        ...
        MAX_ROWS = 40
        send_cols = ["Month","Department","Account_Type","Account_Desc",
                     "Budget_Allocated","Actual_Effective","Variance_Effective","Variance_Percent_Effective"]
        send_cols = [c for c in send_cols if c in df_q.columns]
